...
class CuentaBanco(models.Model):
    ...
    banco = models.ForeignKey(Banco, related_name='sadiochouno_banco_cta')
    condominio = models.ForeignKey(Condominio, related_name='sadiochouno_cta_condominio')
...
class Condomino(models.Model):
    ...
    def cargos(self):
        return '<a href="/admin/c_sadiochouno/asiento/?condomino__id__exact=%d">Cargos view</a>' % (self.id)

    #http://127.0.0.1:8000/admin/c_olimpo/movimiento/?condomino__id__exact=10

    def depositos(self):
        return '<a href="/admin/c_sadiochouno/movimiento/?condomino__id__exact=%d">Depositos view</a>' % (self.id)
...
class Documento(models.Model):
    ...
    situacion = models.ForeignKey(Situacion, blank=True, null=True, related_name='sadiochouno_recibo_situacion_id')
    tipo_documento = models.ForeignKey(TipoDocumento, blank=True, null=True, related_name='sadiochouno_recibo_tipodoc_id')
...
class Movimiento(models.Model):
    cuenta_banco = models.ForeignKey(CuentaBanco, related_name='sadiochouno_mov_cuenta_id', default = 1)
    fecha = models.DateField(blank=True, null=True)
    tipo_movimiento = models.ForeignKey(TipoMovimiento, blank=True, null=True, related_name='sadiochouno_mov_tipo_mov_id')
...
class Asiento(models.Model):
    ...
    tipo_movimiento = models.ForeignKey(TipoMovimiento, blank=True, null=True, related_name='sadiochouno_aux_tipo_mov_id')
    descripcion = models.CharField(max_length=250, blank=True, null=True)
    ...
    condomino = models.ForeignKey(Condomino, related_name='sadiochouno_aux_condomino_id', default=67)
    a_favor = models.ForeignKey(Proveedore, related_name='sadiochouno_aux_proveedor_id', default=1)
